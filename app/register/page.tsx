    ...
    if (successMode) {
        return (
            <div className="min-h-screen flex items-center justify-center p-6 bg-[#0a0a0a]">
                <div className="w-full max-w-[420px] auth-card rounded-[2rem] p-10 text-center animate-in fade-in zoom-in-95 duration-700">
                    ...
                    <h1 className="text-2xl font-bold mb-3 text-white">Verification Sent</h1>
                    <p className="text-muted/60 text-sm mb-10 leading-relaxed">
                        We've sent a magic link to <span className="text-white font-semibold">{successEmail}</span>.
                        Please check your inbox to finish.
                    </p>
                    <Link href="/login" className="w-full btn btn-primary h-12 rounded-full font-bold text-sm block flex items-center justify-center transition-all active:scale-95">
                        Back to Login
                    </Link>
                </div>
            </div>
            ...
            <div className="w-full max-w-[420px] animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-out">
                <div className="auth-card rounded-[2rem] p-10 relative overflow-hidden">
                    <div className="text-center mb-10">
                        ...
                        <h1 className="text-3xl font-bold tracking-tight text-white mb-3">Create Account</h1>
                        <p className="text-muted/60 text-sm font-medium">Join the next generation of gaming content.</p>
                    </div>
                    ...
                    <p className="mt-10 text-center text-sm text-muted/50 font-medium">
                        ...
                        <Link href="/login" className="text-white font-bold hover:text-primary transition-colors">Sign in</Link>
                    </p>
                </div>
            </div>
        </div>
