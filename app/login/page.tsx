                ...
                <div className="bg-white/[0.02] backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden shadow-2xl">
                    ...
                    <div className="px-8 pb-4">
                        <div className="relative flex items-center mb-6">
                            ...
                            <span className="flex-shrink-0 mx-4 text-xs font-medium text-gray-500 uppercase tracking-widest">Or continue with</span>
                            <div className="flex-grow border-t border-white/10"></div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-6">
                            <button
                                ...
                                className="w-full py-3 rounded-xl font-bold text-sm bg-white text-black hover:bg-gray-100 transition-colors flex items-center justify-center gap-2"
                            >
                            ...
                            <button
                                ...
                                className="w-full py-3 rounded-xl font-bold text-sm bg-black text-white hover:bg-zinc-900 border border-white/10 transition-colors flex items-center justify-center gap-2"
                            >
